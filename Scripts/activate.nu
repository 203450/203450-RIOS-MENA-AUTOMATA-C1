...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Archivos\Tareas\Autómatas\Automata c1\automatac1'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Archivos\Tareas\Autómatas\Automata c1\automatac1\Scripts\deactivate.nu'
